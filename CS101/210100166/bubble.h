...
public:
    ...
    void nextStep(double t)
    {
        ...
        if ((vy < 0 && new_y < (40 + circle.getRadius())) // bounce along y direction at up line
            ||
            (vy > 0 && new_y > ((WINDOW_Y) - (50) - circle.getRadius()))) // bounce along y direction at down line
        {
